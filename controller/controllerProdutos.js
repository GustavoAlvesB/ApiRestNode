...
exports.getListProdutos = (req, res, next)=>{ 
...
exports.postCadastroDeProdutos =  (req, res, next)=>{  
...
exports.pathAtualizarProduto =(req, res, next)=>{
     mysql.getConnection((error,conn)=>{   
        if (error) {
            return res.status(500).send({error: error})
        }     
...
exports.deleteExcluirProduto =  (req, res, next)=>{
    /*  testando rota
     res.status(201).send({
